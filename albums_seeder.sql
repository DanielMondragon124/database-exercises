...
INSERT INTO albums (artist, name, release_date, sales, genre) VALUES
    ...
    ('Jim Jacobs', 'Grease: The Original Soundtrack from the Motion Picture', 1978, 14.4, 'Soundtrack'),
    ...
    ('Michael Jackson', 'Dangerous', 1991, 16.3, 'Rock, Funk, Pop'),                                                              ('Madonna', 'The Immaculate Collection', 1990, 19.4, 'Pop, Dance'),
